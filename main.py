...
VALID_CITIES = ["Adana", "Adıyaman", "Afyonkarahisar", "Ağrı", "Aksaray", "Amasya", "Ankara", "Antalya", "Artvin", "Aydın",
...
def validate_city(address_city, full_address):
    if address_city not in VALID_CITIES:
...
def webhook():
    ...
    try:
        ...
        return jsonify({"success": True, "message": "Order saved in test mode."})
